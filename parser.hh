...
#line 55 "parser.hh" // lalr1.cc:371
...
#line 4 "parser.yy" // lalr1.cc:371
namespace AnASM {
#line 78 "parser.hh" // lalr1.cc:371
  ...
  public:
    ...
    union union_type
    {
      ...
      // program
      char dummy3[sizeof(std::vector<instruction> )];

      // statements
      // statement
      char dummy4[sizeof(variant)];
};
  ...
  basic_symbol (typename Base::kind_type t, const variant v, const location_type& l);
    ...
    static inline
    symbol_type
    make_BRA (const location_type& l);

    static inline
    symbol_type
    make_BRAZ (const location_type& l);

    static inline
    symbol_type
    make_BRAL (const location_type& l);

    static inline
    symbol_type
    make_BRALZ (const location_type& l);
    ...
    Parser (AnASM::Lexer &lexer_yyarg, AnASM::Driver &driver_yyarg);
    virtual ~Parser ();
    ...
    , location (other.location)
  {
      switch (other.type_get ())
    {
      ...
      case 24: // statements
      case 25: // statement
        value.copy< variant > (other.value);
        break;
  ...
  template <typename Base>
  Parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const variant v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  Parser::basic_symbol<Base>::~basic_symbol ()
  {
   ...
   default:
    ...
    switch (yytype)
    {
      ...
      case 24: // statements
      case 25: // statement
        value.template destroy< variant > ();
        break;
  ...
  {
    return symbol_type (token::TOK_BRA, l);
  ...
  {
    return symbol_type (token::TOK_BRAZ, l);
  ...
  {
    return symbol_type (token::TOK_BRAL, l);
  ...
  {
    return symbol_type (token::TOK_BRALZ, l);
...
#line 1127 "parser.hh" // lalr1.cc:371
